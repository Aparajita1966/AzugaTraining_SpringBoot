...
public class Museum {
    ...
    public void setAccessionYear(Integer accessionYear) {
        this.accessionYear = (null != accessionYear ? accessionYear : 0);
    }
    ...
    public void setObjectBeginDate(Integer objectBeginDate) {
        this.objectBeginDate = (null != objectBeginDate ? objectBeginDate : 0);
    }
    ...
    public void setObjectEndDate(Integer objectEndDate) {
        this.objectEndDate = (null != objectEndDate ? objectEndDate : 0);
    }
    ...
    public String getIsTimelineWork() {
        return isTimelineWork;
    }

    public void setIsTimelineWork(String isTimelineWork) {
